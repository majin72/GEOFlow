...
from geo_monitor_poc.cli import ask, captcha, discover, login, probe
...
def main() -> int:
    ...
    if not argv or argv[0] in {"-h", "--help"}:
        print("用法: python -m geo_monitor_poc <login|captcha|discover|probe|ask> [options]")
        print("示例: ./run.sh captcha --platform doubao --account-id doubao_guest")
