@php
    ...
    $subMap = [
        ...
        'admin.geo-monitoring.index' => 'geo_monitoring',
        'admin.geo-monitoring.projects.create' => 'geo_monitoring',
        'admin.geo-monitoring.projects.store' => 'geo_monitoring',
        'admin.geo-monitoring.projects.edit' => 'geo_monitoring',
        'admin.geo-monitoring.projects.update' => 'geo_monitoring',
        'admin.geo-monitoring.projects.deactivate' => 'geo_monitoring',
        'admin.geo-monitoring.project' => 'geo_monitoring',
        'admin.geo-monitoring.runs.store' => 'geo_monitoring',
        'admin.geo-monitoring.accounts.index' => 'geo_monitoring',
        'admin.geo-monitoring.accounts.create' => 'geo_monitoring',
        'admin.geo-monitoring.accounts.store' => 'geo_monitoring',
        'admin.geo-monitoring.accounts.edit' => 'geo_monitoring',
        'admin.geo-monitoring.accounts.update' => 'geo_monitoring',
        'admin.geo-monitoring.accounts.toggle' => 'geo_monitoring',
        'admin.geo-monitoring.proxies.index' => 'geo_monitoring',
        'admin.geo-monitoring.proxies.create' => 'geo_monitoring',
        'admin.geo-monitoring.proxies.store' => 'geo_monitoring',
        'admin.geo-monitoring.proxies.edit' => 'geo_monitoring',
        'admin.geo-monitoring.proxies.update' => 'geo_monitoring',
        'admin.geo-monitoring.proxies.toggle' => 'geo_monitoring',
        'admin.geo-monitoring.profiles.index' => 'geo_monitoring',
        'admin.geo-monitoring.profiles.create' => 'geo_monitoring',
        'admin.geo-monitoring.profiles.store' => 'geo_monitoring',
        'admin.geo-monitoring.profiles.edit' => 'geo_monitoring',
        'admin.geo-monitoring.profiles.update' => 'geo_monitoring',
        'admin.geo-monitoring.run' => 'geo_monitoring',
