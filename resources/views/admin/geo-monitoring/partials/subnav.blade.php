<nav class="flex flex-wrap gap-3 text-sm">
    ...
    <a href="{{ route('admin.geo-monitoring.dashboard') }}" class="text-blue-600 hover:text-blue-800">{{ __('admin.geo_monitoring.dashboard_title') }}</a>
    <span class="text-gray-300">|</span>
    ...
    <span class="text-gray-300">|</span>
    <a href="{{ route('admin.geo-monitoring.settings.index') }}" class="text-blue-600 hover:text-blue-800">{{ __('admin.geo_monitoring.nav_settings') }}</a>
</nav>
